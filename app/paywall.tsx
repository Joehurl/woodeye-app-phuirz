...
const FEATURES = [
  {
    ...
    description: "Identify as many wood species as you want with no limits",
  },
  {
    icon: "🌲",
    title: "Full Species Database",
    description: "Access detailed info on hundreds of wood species worldwide",
  },
  {
    icon: "📋",
    title: "Complete Scan History",
    description: "Keep and browse your full history of wood identifications",
  },
  {
    icon: "⚡",
    title: "Priority AI Analysis",
    description: "Faster, more accurate wood identification results",
  },
];
